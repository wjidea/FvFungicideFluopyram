...
fullPlateData$growthRate <- (sqrt(fullPlateData$Area2/pi) - 
                               sqrt(fullPlateData$Area1/pi))/10
...
ggplot(EC50SumFilterPlate, aes(x=EC50)) + 
...
ggplot(EC50SumFilterConidia, aes(x=EC50)) + 
...
####Figure 3
```{r Figure 3 EC50 distribution based on state, echo=FALSE}
...
####Figure 4
```{r Figure 4 compare two methods, echo=FALSE}
