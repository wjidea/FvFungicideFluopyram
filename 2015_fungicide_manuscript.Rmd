...
#### Table 3
```{r Table 3 data prep,cache=TRUE,echo=FALSE, warning=FALSE, eval=FALSE}
...
write.csv(LL4vsBC4All, "LL4vsBC4.csv")
...
setwd(dataPath)
LL4vsBC4Table <- read.csv("LL4vsBC4.csv", row.names = 1)
# duplicated(LL4vsBC4Table$Strain)
# row1 <- nrow(LL4vsBC4Table)
# LL4vsBC4Table[-c(seq(row1-4, row1)),]
