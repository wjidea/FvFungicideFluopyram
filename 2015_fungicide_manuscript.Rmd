...
### 4) Calculate EC50 for poison plate assay
...
# dim(EC50PlateSum)
# dim(EC50PlateSum[EC50PlateSum$EC50 > 2 & EC50PlateSum$EC50 < 4, ])
# 
# # dim(EC50PlateSum)
# 
# plateM.1 <- lm(EC50 ~ State + Year ,EC50PlateSum)
...
```{r Histogram EC50 distrubnution (plate), echo=FALSE, width = 14}
