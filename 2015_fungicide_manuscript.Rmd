...
filter(fullPlateDataExclude50, setStrain == "14@Mont1")

# detect if there is a hormetic effect
for (strain in levels(factors(fullPlateDataExclude50$setStrain))) {
...
fullPlateDataExclude50[fullPlateDataExclude50$setStrain == "1@Mo4a"]
...
####Figure 2-1 Growth curve fit (Plate and conidia)
...
####Figure 2-2 Growth curve fit (conidia)
...
text(x=1.5, y=3.5, cex=0.8, label = expression(atop(italic("y = 2.553 + 0.369x"),
...
66/74
# conidia assay anova
conidiaM.1 <- lm(EC50 ~ State + Year ,EC50ConidialTable)
