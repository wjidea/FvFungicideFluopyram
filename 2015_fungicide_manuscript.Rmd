...
dataPlatePath <- file.path("/Users/wjidea/GoogleDrive/Graduate_Study",
...
```{r cal plate EC50, results = "hide", warning = FALSE, cache = TRUE}
...
EC50SumFilter <- EC50Sum[EC50Sum$pvalue <= 0.05,]

# clean up environment by removing unused objects
...
### 1) Statistics
### 2) Figures
```{r Histogram EC50 distrubnution, echo=FALSE}
