...
#### Table 3
```{r Table 3 data prep,cache=TRUE,echo=FALSE, warning=FALSE, eval=TRUE}
...
# add geo metadata for the summarize for isolates not in the final table
...
newECTableConidia_1 <- merge(EC50ConidialTable, conidiaRelInhPerc,
                             by.x="Strain", by.y="Isolate")

# obtain isolates that do not have 20 ppm in the settings
conidiaIsolateNo20ppm <- coniNoNaData[!(coniNoNaData$Isolate %in% 
                                          conidiaRelInhPerc$Isolate),]
isolateConidiaNo20ppmNames <- unique(conidiaIsolateNo20ppm$Isolate)
#isolateTableNames1 <- unique(newECTableConidia_1$Strain)
#allConidiaIsolateNames[!(allConidiaIsolateNames %in% c(isolateTableNames1,isolateConidiaNo20ppmNames))]

# conidiaRelInhPerc[conidiaRelInhPerc$Isolate %in% "13Fv190",]

newECTableConidia_2 <- EC50ConidialTable[EC50ConidialTable$Strain %in% isolateConidiaNo20ppmNames,]

naDF_1 <- data.frame(N=4*NA, relInhibition=4*NA,relSE=4*NA)
newECTableConidia_2_1 <- cbind(newECTableConidia_2, naDF_1)

newECTableConidia <- rbind(newECTableConidia_1,newECTableConidia_2_1)

# conidiaRelInhPerc[conidiaRelInhPerc$Isolate %in% "13Fv190",]

# add 13 Fv19 to final list

kable(newECTableConidia, 
